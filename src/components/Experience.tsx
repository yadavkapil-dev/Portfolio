...
const roles = [
  {
    ...
    description:
      "Developed custom WordPress plugins using PHP, MySQL, and WordPress APIs to automate manual workflows. Built admin dashboard features, file uploads, automated notifications, request tracking, and server-side validation, while collaborating in an Agile development environment. Also built and tested an AI chatbot integration on a staging environment to assist visitors and handle pre-qualifying questions.",
  },
  {
